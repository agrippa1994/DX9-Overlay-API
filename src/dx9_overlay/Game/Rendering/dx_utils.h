...
namespace Drawing
{
	...
	void DrawSprite(LPD3DXSPRITE SpriteInterface, LPDIRECT3DTEXTURE9 TextureInterface, int PosX, int PosY, int Rotation, int Align, float scaleX = 1.0f, float scaleY = 1.0f);
}
